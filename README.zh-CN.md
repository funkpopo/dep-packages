...
<p align="center">
  <a href="https://marketplace.visualstudio.com/items?itemName=funkpopo.depdetect"><img src="https://img.shields.io/visual-studio-marketplace/v/funkpopo.depdetect?label=VS%20Code%20Marketplace&logo=visual-studio-code" alt="Visual Studio Marketplace 版本"></a>
  <a href="https://marketplace.visualstudio.com/items?itemName=funkpopo.depdetect"><img src="https://img.shields.io/visual-studio-marketplace/i/funkpopo.depdetect?label=Installs" alt="Visual Studio Marketplace 安装量"></a>
  <a href="./LICENSE"><img src="https://img.shields.io/badge/license-MIT-blue.svg" alt="MIT 许可证"></a>
</p>

DepDetect 会在受支持的依赖文件中直接显示版本状态标记。将鼠标悬停在依赖项上，即可浏览已发布版本、打开对应的软件包页面，或单击版本号完成替换。你也可以从命令面板一次更新当前文件中检测到的全部依赖。
...
5. 选择一个版本替换当前版本；也可以打开命令面板（`Ctrl+Shift+P` / `Cmd+Shift+P`），运行 **DepDetect: Update All dependencies of the active dependency file**。
...
| 命令 | 说明 |
| --- | --- |
| **DepDetect: Update All dependencies of the active dependency file** | 将当前文件中检测到的全部依赖替换为各自的最新稳定版本，并保存文件。 |
...
- **Update All** 会把检测到的每个依赖更新到其最新稳定版本，其中可能包含主版本升级，请在提交前检查产生的改动。
