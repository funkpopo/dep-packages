...
<p align="center">
<a href="https://marketplace.visualstudio.com/items?itemName=funkpopo.depdetect" target="__blank"><img src="https://img.shields.io/visual-studio-marketplace/v/funkpopo.depdetect.svg?color=eee&amp;label=VS%20Code%20Marketplace&logo=visual-studio-code" alt="Visual Studio Marketplace Version" /></a>
</p>

<p align="center">
DepDetect is a VS Code extension for Node.js, Python, Go, and Maven dependencies. It helps developers inspect and update versions directly in project dependency files.
</p>

## Features

- Displays the latest version of npm, PyPI, Go modules, and Maven Central artifacts next to them.
- Shows all versions (clickable) on the tooltip of a hovered dependency.
- Supports `package.json`, Python `requirements.txt` and `pyproject.toml`, Go `go.mod`, and Maven `pom.xml` files.
